...
class ForgotPasswordCase implements Usecase<void, String> {
  final AuthRepositories authRepositories;

  ForgotPasswordCase({required this.authRepositories});
  
  @override
  Future<Either<Failure, void>> call(String email) async {
    return await authRepositories.resetPassword(email);
  }
}
